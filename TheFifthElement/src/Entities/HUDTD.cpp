...
void HUDTD::indexSkin(string skin)//estoy dudando si es necesario aunque lo puedo hacer funcionar si luego hago otro array y así traslado indexes
{
	int x;
...
void HUDTD::rotateWheel(int index)
{
