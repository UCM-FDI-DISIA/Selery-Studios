...
StateManager* GameStateMachine::currentState() // consulta del estado actual
{
	return st.top();
}

void GameStateMachine::pushState(StateManager* myState) // push del nuevo estado y entra en él 
{
	st.push(myState);
}

void GameStateMachine::changeState(StateManager* myState) // cambio de estado
{
